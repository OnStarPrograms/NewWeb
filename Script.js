...
function loadData()
{
    ...
    if (jsonner.Information[Math.abs(track2)].Data.Projects == true)
    {
        for (var i = 0; i < projects.length; i++)
        {
            ...
            document.getElementById("Text").innerHTML += "<h4 id = 'ProgHead' style = 'text-decoration: underline;'>"+current_Project.Project_Name+"<h4>";
            ...
            for (var j = 0; j < current_Project.Project_info.length; j++)
                document.getElementById("Text").innerHTML += "<h4 id='ProgBody'>"+current_Project.Project_info[j]+"<h4>";
            if (mset == 0)
            {
                load_images(current_Project.image);
            }
